...
class AlwaysCoopSeqJustifiedBFS(AbstractPolicyStrategy):
    """
    Basic algorithm is from S-JBFS, but:
    Agents always assume that all other agents have the same goals as their own.
    """
